...
export default function usePeriods({
    ...
    const currentDay = useMemo(()=>formatJsDateToDateString((calender==='ethiopic'?(currentDate?.serverDate)?.toLocaleDateString('en-GB-u-ca-ethiopic'):currentDate.serverDate)),[calendar]);
